        ...
        >
            <div className="w-[45%] min-w-[350px] h-[57%] bg-gradient-to-br from-gray-300 to-white rounded-3xl grid grid-rows-[30%] grid-cols-1">  
                ...
                <input 
                    ...
                    className="row-span-1 w-[85%] h-[60px] place-self-center rounded-lg border-solid border-2 border-gray-400 pl-4 text-lg" 
                />
                ...
                <input 
                    ...
                    className="w-[85%] h-[60px] place-self-center rounded-lg border-solid border-2 border-gray-400 pl-4 text-lg"
                />
                
                <div className="relative flex justify-center items-center w-full h-full">
                    <button 
                        className='bg-gray-800 text-white rounded-3xl w-36 h-11 text-2xl hover:opacity-50 ease-in-out duration-200' 
