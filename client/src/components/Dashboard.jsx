...
export default function Dashboard ({ handleClickDashboard, canceledFunc }) {
    return (
        <div className='bg-slate-100 w-screen h-20 flex items-center fixed top-0 z-10'>
            ...
            <div className='dashboard-group justify-end pr-6'>
                ...
                <button onClick={canceledFunc} value='signIn' className='dashboard-header-title'>Sign in</button>
